...
func main() {
	os.Setenv("DATABASE_URL", "postgres://postgres:password@localhost:5432/postgres") // Hapus jika akan melakukan deploy ke fly.io
...
func FlyURL() string {
	...
	return "https://febriando-be3187066.fly.dev" // TODO: replace this
}
