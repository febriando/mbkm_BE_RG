...
func MoneyChange(money int, listPrice ...int) string {
	...
	// 	jumlahHarga := listPrice[i] + listPrice[i+1]
	// 	fmt.Println(jumlahHarga)
	// }
	var sum int = 0
	...
	return string(ChangeToCurrency(result)) // TODO: replace this
}

// gunakan untuk melakukan debug
func main() {
	fmt.Println(MoneyChange(2000, 50000, 10000, 10000, 5000, 5000))
}
